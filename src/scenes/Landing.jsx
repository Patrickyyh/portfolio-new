        ...
        <div className="md:order-2 flex justify-center basis-3/5 z-10 mt-16 md:mt-32">
            ...
            <div className="z-30 basis-2/5 mt-12 md:mt-32">
                ...
                >
                    ...
                    <p className="text-2xl mt-10 mb-7 text-sm text-center md:text-start">
                    As it so contrasted oh estimating instrument.
                    Size like body some one had. Are conduct viewing boy minutes warrant expense.
                ...
                <motion.div
                 ...
                 >
                    ...
                    <AnchorLink
                        className="bg-gradient-rainblue text-deep-blue rounded-sm
                        py-3 px-7 font-semibold hover:bg-blie hover:text-white transition duration-500"
